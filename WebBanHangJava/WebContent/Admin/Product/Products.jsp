...
<link href="../Admin/assets/css/paper-dashboard.css?v=2.0.1"
	rel="stylesheet" />
...
<body class="">
	...
	<script
		src="../Admin/assets/js/plugins/perfect-scrollbar.jquery.min.js"></script>
	<!--  Google Maps Plugin    -->
	...
	<script src="../Admin/assets/js/paper-dashboard.min.js?v=2.0.1"
